...
const Orders = () => {
  ...
  const hasOrders = Object.keys(ordersGroupedByDate).length > 0;

  return (
    <div className="h-[90vh] md:ml-36 mb-10 lg:ml-48 xl:ml-64 overflow-y-auto bg-gray-100 py-10 px-5">
      ...
      {!hasOrders ? (
        <div className="flex flex-col justify-center items-center h-[70vh] mt-5">
          <Lottie options={defaultOptions} height={350} width={200} /><br />
          <h1 className='font-bold'>You haven't make your first ORDER yet ? <Link to="/categories"><span className=' text-blue-500 underline'>Click to ORDER</span></Link></h1>
        </div>
      ) : (
