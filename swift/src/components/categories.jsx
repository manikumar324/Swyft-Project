        ...
        <div className='grid grid-cols-4 gap-4 md:gap-6 mx-2'>
            ...
            <Link to="/categories/grocery&kitchen/meat-fish&more">
                <div>
                    ...
                    <h3 className='font-medium text-xs md:font-bold md:text-lg text-center'>Meat,Fish<br className='md:hidden'/>& Eggs</h3>
                </div>
            </Link>
            ...
            <div>
                ...
                <h3 className='font-medium text-xs md:font-bold md:text-lg text-center'>Breakfast<br className='md:hidden'/>& Sauces</h3>
            </div>
            </Link>
            ...
            <div>
                ...
                <h3 className='font-medium text-xs md:font-bold md:text-lg text-center'>Packaged<br className='md:hidden'/>Food</h3>
            </div>
            </Link>
        </div>
      </div>
        ...
        <Link to="/categories/snacks&drinks/cooldrinks-juices" className='col-span-2'>
            ...
            <Link to="/categories/snacks&drinks/chips-munchies&more">
                <div>
                    ...
                    <h3 className='font-medium text-xs md:font-bold md:text-lg text-center'>Munchies<br className='md:hidden'/>& Chips</h3>
                </div>
            </Link>
